...
import type { Chart, TimeItem, PrimitiveRow, Direction as DirectionType } from './types'
...
export function detectDirection(previousRow: number[], currentRow: number[]): [DirectionType, boolean] {
