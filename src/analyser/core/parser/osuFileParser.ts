...
import type { NoteTimes, ParsedBeatmap, ParserStatus } from './types'
...
export class OsuFileParser {
  ...
  public noteStarts: number[]
  public noteEnds: number[]
  public noteTypes: number[]
  public gameMode: string | null
  public status: ParserStatus
  public lnRatio: number
  public noteTimes: NoteTimes
  public metaData: Record<string, string>
  public breaks: [number, number][]
  public objectIntervals: [number, number][]
  public timingPoints: [number, number][]
  ...
  private parseEventLine(eventLine: string): void {
  ...
  private parseHitObject(objectLine: string): void {
  ...
  private parseTimingPointLine(timingLine: string): void {
  ...
  getNoteTimes(): NoteTimes {
    const noteTimes: NoteTimes = {}
    ...
    for (const key of Object.keys(noteTimes)) {
      noteTimes[Number(key)].sort((a, b) => a - b)
    }

    return noteTimes
  }

  getObjectIntervals(): [number, number][] {
  ...
  modIN(): void {
    ...
    const newObjects: [number, number, number][] = []
